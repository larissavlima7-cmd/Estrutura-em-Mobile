...
class _TodoListViewState extends State<TodoListView> {
  ...
  //_ =>o uso do _ trnsforma a váriavel em private
  final TextEditingController _tarefasController = TextEditingController(); //pegar o valor do input
  final List<Map<String,dynamic>> _tarefas = []; //lista de coleções [{},{},{}]
  //métodos
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            //espaçamento
            SizedBox(height: 20,),
            ElevatedButton(onPressed: _adicionarTarefa,//metodo para adicionar tarefa a lista
            child: Text("Adicionar Tarefa")),
            //listra as tareafas da lista
